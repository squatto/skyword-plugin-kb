...
function skyword_plugin_options() {
	...
	<style type="text/css">
		...
		.skyword-settings form {
			margin-top: 40px;
		}

		.skyword-settings .form-table {
			background: #fff;
			padding: 20px;
			margin-bottom: -5px;
		}
		...
		.skyword-settings h2 {
			background: url(http://www.skyword.com/wp-content/themes/skyword/images/s.png) no-repeat;
			height: 30px;
			min-width: 300px;
		}

		.skyword-settings h2 span {
			display: none;
		}

		.skyword-settings .subSitemap, .skyword-settings .subSitemap + p {
			margin-left: 30px;
		}
