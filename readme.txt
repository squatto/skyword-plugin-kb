=== Skyword API Plugin with knowledge-base support  ===
Contributors: skyword, PXP
Tags: skyword, api
Requires at least: 3.3
Tested up to: 4.4.2
Stable tag: 2.2.3

Allows integration with the skyword publishing platform, extended to include knowledge-base support through the Heroic Knowledge Base plugin.
